# Quelques requêtes pratiques pour Oracle

## Plutot dev
Suppression de toutes les tables du schema:
...
```
select SID, SERIAL#, to_char(logon_time, 'DD/MM/YYYY HH24:MI:SS') , USERNAME, PROGRAM, STATUS, PROCESS, MACHINE, OSUSER, sql_text
